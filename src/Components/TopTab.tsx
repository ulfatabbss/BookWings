  ...
  return (
    ...
    style={[styles.container]}>
      <View style={{flexDirection:'row',justifyContent:'space-between'}}>
       ...
       {back=='1'?undefined: <TouchableOpacity onPress={()=>navigation.goBack()}>
        <Image
       style={[styles.img1,]}
        resizeMode='contain'
...
<TouchableOpacity onPress={()=>navigation.navigate('EditProfile')}>
      ...
      <Image style={{height:RF(23),width:RF(23)}} resizeMode='contain' source={require('../assets/Images/CommonImages/EditIcon.png')} />
...
const styles = StyleSheet.create({
    container:{
      ...
      alignItems:'center',
        ...
        height:RFP(10),
        alignSelf:'center',
        justifyContent:'space-between',backgroundColor:'#e9e7ed'
      },
      img1:{
        height:25,
        width:20,
