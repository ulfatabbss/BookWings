...
const GetStarted   = ({navigation}:GenericNavigation) => {
  ...
  return (
    ...
    <View style={{width:'90%',alignSelf:'center',marginTop:RFP(2),alignItems:'center'}}>
...
<Image  style={styles.socialbtnImg} resizeMode='contain' source={require('../../assets/Images/GetStarted/google.png')}/>
      </TouchableOpacity>
      <TouchableOpacity style={styles.socialbtn}>
<Image  style={styles.socialbtnImg} resizeMode='contain' source={require('../../assets/Images/GetStarted/apple.png')}/>
      </TouchableOpacity>
...
const styles = StyleSheet.create({
  GetStartedbtn:{height:RF(48),width:'90%',alignSelf:'center',justifyContent:'center',alignItems:'center',backgroundColor:'#3F51B5',
borderRadius:RF(90),marginTop:RFP(5)},
mainTxt:{fontSize:RF(18),fontFamily:'Inter-Bold',color:'#3F51B5'},
subHeading:{fontSize:RF(12),fontFamily:'Inter-Regular',color:'#000',textAlign:'center',marginTop:RFP(1.5),width:'90%'},
GetStartedbtnTxt:{fontSize:RF(14),fontFamily:'Inter-SemiBold',color:'#fff'},
btnTxt:{fontSize:RF(12),fontFamily:'Inter-Medium',color:'#009688'},
socialViewbtn:{flexDirection:'row',width:'90%',alignSelf:'center',justifyContent:'space-between',marginTop:RFP(1),},
socialbtn:{height:RF(40),width:'45%',backgroundColor:'#F1F1F1',borderRadius:RF(90),alignItems:'center',justifyContent:'center'},
