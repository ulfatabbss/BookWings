...
const styles = StyleSheet.create({
  ...
  LogoTxt:{fontSize:RF(18),fontFamily:'Inter-SemiBold',marginLeft:RFP(1),color:'#000'},
  ...
  seach_input_txt: {color:'#000',width: '80%',height:'80%',marginLeft: RFP(1), alignSelf: 'center',  fontSize: RF(12), fontFamily: 'Inter-Light'},
