...
const EbookDetail = ({navigation, route}) => {
    ...
    <SafeAreaView style={{flex: 1, backgroundColor: '#e9e7ed'}}>
      ...
      <View style={{height: '100%', width: '100%', backgroundColor: '#FFFF'}}>
        ...
        <View
          ...
          <View
            ...
            <View
              ...
              <Image
                style={{height: RF(21), width: RF(21)}}
                resizeMode="contain"
                source={require('../../assets/Images/CommonImages/ratingStar.png')}
              />
              <Text
                style={{
                  color: '#000',
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            navigation.navigate('ReadBook', {book: data.book_file_name})
          }>
          <Text
            style={{
              color: '#FFF',
